-- Sample data: universities in Yaoundé, Cameroon. Programmes are grouped by their School/faculty.
...
-- Universities (Yaoundé only), each with a brief history
INSERT INTO school (name, category, description, history, city, region, address, latitude, longitude, tuition_fee, currency, website, phone, email, cover_image_url) VALUES
    ('University of Yaoundé I', 'UNIVERSITY',
     ...
     'Established in 1962 as Cameroon''s first university and reorganised into the University of Yaoundé I in 1993, it is the country''s oldest and largest university, renowned for the sciences, medicine, the arts and engineering.',
     'Yaoundé', 'Centre', 'Ngoa-Ekellé, Yaoundé', 3.8667, 11.4986, 50000, 'XAF', 'https://www.uy1.cm', NULL, NULL, NULL),
    ...
    ('University of Yaoundé II', 'UNIVERSITY',
     ...
     'Created in 1993 from the reform that split the University of Yaoundé, and based in Soa near Yaoundé, it specialises in law, economics, management, political science and governance.',
     'Yaoundé', 'Centre', 'Soa, Yaoundé', 3.9810, 11.5650, 50000, 'XAF', NULL, NULL, NULL, NULL),
    ...
    ('Catholic University of Central Africa (UCAC)', 'UNIVERSITY',
     ...
     'Founded in 1989 by the Catholic bishops of Central Africa and opened in 1991, UCAC is a leading private institution in Yaoundé, recognised for management, law, social sciences and health.',
     'Yaoundé', 'Centre', 'Nkolbisson, Yaoundé', 3.8730, 11.4380, 900000, 'XAF', 'https://www.ucac-icy.net', NULL, NULL, NULL),
    ...
    ('Protestant University of Central Africa (UPAC)', 'UNIVERSITY',
     ...
     'Established in 2007 by the Protestant churches of Central Africa, UPAC in Yaoundé offers programmes in theology, health sciences and management.',
     'Yaoundé', 'Centre', 'Djoungolo, Yaoundé', 3.8900, 11.5210, 800000, 'XAF', NULL, NULL, NULL, NULL),

    ('The ICT University', 'UNIVERSITY',
     'Private university focused on information and communication technology and business.',
     'A private university with American academic roots, The ICT University operates from Yaoundé with a focus on information and communication technology, computing and business, offering on-campus and blended programmes.',
     'Yaoundé', 'Centre', 'Messassi, Yaoundé', 3.9180, 11.5360, 750000, 'XAF', 'https://ictuniversity.org', NULL, NULL, NULL),
    ...
    ('PKFokam Institute of Excellence', 'UNIVERSITY',
     ...
     'Founded by Dr Paul K. Fokam, the entrepreneur behind Afriland First Bank, the PKFokam Institute of Excellence in Yaoundé trains students in computing, business, banking and finance with a strong entrepreneurship focus.',
     'Yaoundé', 'Centre', 'Santa Barbara, Yaoundé', 3.8400, 11.5300, 700000, 'XAF', NULL, NULL, NULL, NULL),

    ('Yaoundé International Business School (YIBS)', 'UNIVERSITY',
     'Affiliated with the University of Bamenda (UBa). Offers HND, Bachelor (BTech) and Master programmes across business & finance, management, communication, tourism & hotel management, computer engineering, medical sciences and home economics. Day & evening sessions.',
     'Yaoundé International Business School (YIBS) is a private bilingual higher-education institution in Yaoundé, academically affiliated with the University of Bamenda (UBa). Organised into specialised schools, it delivers professional HND, Bachelor (BTech) and Master (MTech / MBA) programmes — with day and evening sessions — across business, management, communication, tourism, computer engineering, health and home economics.',
     'Yaoundé', 'Centre', 'Bastos, Yaoundé', 3.8950, 11.5180, 850000, 'XAF', NULL, NULL, NULL, NULL),
    ...
    ('CITEC Higher Institute of Technology (CITEC)', 'UNIVERSITY',
     ...
     'CITEC is a private higher institute of technology in Yaoundé delivering professional HND and Bachelor programmes in software engineering, networks, security and information systems.',
     'Yaoundé', 'Centre', 'Nsam, Yaoundé', 3.8350, 11.5160, 600000, 'XAF', NULL, NULL, NULL, NULL),

    ('National Advanced School of Engineering (ENSPY)', 'UNIVERSITY',
     'Public grande école of engineering (Polytechnique) under the University of Yaoundé I — trains engineers in civil, computer, electrical and telecommunications engineering.',
     'Created in 1971, the National Advanced School of Engineering (Polytechnique) of the University of Yaoundé I is Cameroon''s premier engineering grande école, training engineers in civil, computer, electrical and telecommunications disciplines.',
     'Yaoundé', 'Centre', 'Melen, Yaoundé', 3.8620, 11.4940, 50000, 'XAF', NULL, NULL, NULL, NULL),

    ('National School of Administration and Magistracy (ENAM)', 'UNIVERSITY',
     'Public professional school training senior civil servants and magistrates in administration, magistracy, customs and treasury.',
     'The National School of Administration and Magistracy (ENAM), established in 1959, trains Cameroon''s senior civil servants, magistrates, customs and treasury officers.',
     'Yaoundé', 'Centre', 'Quartier du Lac, Yaoundé', 3.8700, 11.5100, 50000, 'XAF', NULL, NULL, NULL, NULL),

    ('Sub-regional Institute of Statistics and Applied Economics (ISSEA)', 'UNIVERSITY',
     'CEMAC sub-regional institute training statisticians, statistical engineers and applied economists for Central Africa.',
     'The Sub-regional Institute of Statistics and Applied Economics (ISSEA), a CEMAC institution founded in 1984 and hosted in Yaoundé, trains statisticians, statistical engineers and applied economists for Central Africa.',
     'Yaoundé', 'Centre', 'Nkolbisson, Yaoundé', 3.8740, 11.4350, 50000, 'XAF', NULL, NULL, NULL, NULL);
